...
import classes from "./Dubai.module.css"

import axios from "axios"

function Dubai() {

  const weatherUrl = "https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=77001&distance=25&API_KEY=233C95BB-A17B-4D76-9019-CDD6B336377E"
  ...
  return (
    ...
    <div className={classes.whole}>
      <Heading fontSize="5xl" display="flex" alignItems="center" justifyContent="center"
       marginTop="50px" backgroundColor="pink.500" bgClip="text" 
      >
         {city}
      </Heading>
       ...
       <div className={classes.outer}>
         <div className={classes.top}>
           <Heading fontSize="7xl" _hover={{color:"yellow.300"}} >
               {temp}</Heading>

           <Icon as={icon === "Good" ? WiDayThunderstorm : WiDayCloudy } w={16} h={16}
            marginTop="20px" _hover={{color:"yellow.300"}} />
         </div>
